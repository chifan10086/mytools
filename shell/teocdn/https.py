...
def getdnsid(zoneid):
    ...
    result = pipe.stdout.read().decode()
    data = json.loads(result)
    #print(data['Response']['DnsRecords'][0]['DnsRecordId'])
    dnsid = data['Response']['DnsRecords'][0]['DnsRecordId']
    return dnsid
    #json_data = json.dumps(data, indent=4)
    #print(json_data['Response']['DnsRecords'])

def changesdns(dnsid,zoneid):
...
for domain in domains:
    ...
    dnsid =  getdnsid(zoneid)
    gohttps(zoneid)
    addhttps(zoneid,domain)
    changesdns(dnsid,zoneid)
