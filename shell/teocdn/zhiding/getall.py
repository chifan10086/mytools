...
#    print('命令返回结果')
    ...
    #print(data['Response']['TotalCount'])
    #for i in range(data['Response']['TotalCount']+1):
    #print(len(data['Response']['Zones']))
    for i in range(len(data['Response']['Zones'])):
#         print(data['Response']['Zones'][i])
#         print(data['Response']['Zones'][i]['ZoneName'])
         print(data['Response']['Zones'][i]['ZoneId'])
    #print(json_data)
    #print(data['Response']['TotalCount'])
getall()
